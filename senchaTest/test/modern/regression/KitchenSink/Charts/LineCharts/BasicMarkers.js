...
describe("Basic + Markers", function() {
    ...
    describe(desc, function () {
        ...
        it('Markers are getting bigger by mouseover / tap', function(){
            ST.component('chart')
                .and(function () {
                    var yAxis = Ext.first("chart").getAxes()[0].oldRange[1] / 10;
                    Lib.Chart.mouseover(desc, graph_id_main, 2, (yAxis-31)*h/yAxis, undefined, undefined, [0,1]);
                })
                .and(function () {
                    var yAxis = Ext.first("chart").getAxes()[0].oldRange[1] / 10;
                    Lib.Chart.mouseover(desc, graph_id_main, 2, (yAxis-24.5)*h/yAxis, undefined, undefined, [0,3]);
                })
                .and(function () {
                    var yAxis = Ext.first("chart").getAxes()[0].oldRange[1] / 10;
                    Lib.Chart.mouseover(desc, graph_id_main, 2, (yAxis-13)*h/yAxis, undefined, undefined, 0);
                });
        });
