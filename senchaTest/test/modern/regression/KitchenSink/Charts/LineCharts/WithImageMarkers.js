...
describe("With Image Markers", function() {
    ...
    describe(desc, function () {
        ...
        it('Markers are getting bigger by mouseover / tap', function(){
            ST.component('chart')
                .and(function () {
                    var yAxis = Ext.first("chart").getAxes()[0].oldRange[1];
                    Lib.Chart.mouseover(desc, graph_id_main, 2, (yAxis-130)*h/yAxis, undefined, undefined, [0,0]);
                })
                .and(function () {
                    var yAxis = Ext.first("chart").getAxes()[0].oldRange[1];
                    Lib.Chart.mouseover(desc, graph_id_main, 2, (yAxis-315)*h/yAxis, undefined, undefined, [0,1]);
                })
                .and(function () {
                    var yAxis = Ext.first("chart").getAxes()[0].oldRange[1];
                    Lib.Chart.mouseover(desc, graph_id_main, 2, (yAxis-245)*h/yAxis, undefined, undefined, [0,2]);
                });
        });
