...
describe("Calendar/Drag&Resize Validation", function() {
    ...
    **/
    describe("Drag&Resize Validation example", function() {
        ...
        // TODO: Fails on Mac Chrome 71, iPhone 12, iPad 12 with repeatable timeouts
        describe('Testing "Not draggable" event', function() {
            var eventToTest = "Not draggable";
            var defaultStart = "14:30";
            var defaultEnd = "15:30";
                ...
                ST.element(Components.calendarEventHandle(eventToTest))
                    ...
                    .and(function() {
                        Dash.moveElementToHour({
                            ...
                            dragTo        : Components.calendarHourIndex(Column.LEFT, Dash.hourToIndex(17)),
                            day            : Column.LEFT,
                            answer        : Dialog.YES,
                            reqStartHour: defaultStart,
                            reqEndHour    : "17:00",
        ...
        // TODO: Fails on Mac Chrome 71, iPhone 12, iPad 12
        /**
        * This test script cannot be fixed since,"Not draggable/resizable" event
        * is not available on Sencha 6.7 Calender > Drag/Resize validation
        */
        
        xdescribe('Testing "Not draggable/resizable" event', function() {
        ...
        // TODO: Fails on Mac Chrome 71, iPhone 12, iPad 12
         /**
        * This test script cannot be fixed since,"Unrestricted" event
        * is not available on Sencha 6.7 Calender > Drag/Resize validation
        */
        
        xdescribe('Testing "Unrestricted" event', function() {
